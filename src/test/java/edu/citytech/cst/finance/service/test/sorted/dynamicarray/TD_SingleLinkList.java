...
class TD_SingleLinkList {
	@Test
	@DisplayName("Sum of SingleLinkedList")
	...
	void t4_sumOfNumbersDoubleLinkedList() {
		IList<Double> da = new SingleLinkedList<>(Double[]::new);
	...
	@Test
	@DisplayName("Sum of SingleLinkedList with widget 1 to 3")
	void t7_sumOfNumbersSingleLinkedList() {
		IList<Widget> da=new SingleLinkedList<>(Widget[]::new);
	...
	@Test
	@DisplayName("Sum of SingleLinkedList with widget 1 to 20")
	void t8_sumOfNumbersSingleLinkedList() {
		IList<Widget> da=new SingleLinkedList<>(Widget[]::new);
	...
	@Test
	@DisplayName("Sum of SingleLinkedList with widget 3 to 10")
	void t9_sumOfNumbersSingleLinkedList() {
		IList<Widget> da=new SingleLinkedList<>(Widget[]::new);
	...
	void t10_sumOfNumbersSingleLinkedList() {
		IList<Widget> da=new SingleLinkedList<>(Widget[]::new);
